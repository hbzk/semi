	...
	jQuery.fn.pieChart = function(data,size,formation,title){
		...
		if(formation == "bar"){
					...
					//create background
						...
						this.append('<div class = "pieChart_bar_chart" style="position:relative;"><div class = "pieChart_title" style="position:absolute;left:170px;font-size:14px"></div><div class = "pieChart_bar" style="top:25px;position:relative;"><dl></dl></div><div class = "pieChart_number"><div></div></div><div class = "pieChart_mouseover"></div>');
						//create legend
						/*
