...
(function(a) {
	...
	a.jqx.isPropertySetter = function(c, b) {
		...
		if (b.length == 2 && typeof (b[0]) == "string"
				&& !a.jqx.hasFunction(c, b)) {
			return true;
		}
		return false;
	};
	...
	a.jqx.jqxWidgetProxy = function(g, c, b) {
		...
		throw "jqxCore: Invalid parameter '" + a.jqx.serialize(b)
				+ "' does not exist.";
		return undefined;
	};
	...
	a.jqx.jqxWidget = function(b, d, j) {
		...
		a.fn[g] = function() {
			...
			if (e.length == 0 || (e.length == 1 && typeof (e[0]) == "object")) {
				if (this.length == 0) {
					if (this.selector) {
						throw new Error(
								"Invalid jQuery Selector - "
										+ this.selector
										+ "! Please, check whether the used ID or CSS Class name is correct.");
					} else {
						throw new Error(
								"Invalid jQuery Selector! Please, check whether the used ID or CSS Class name is correct.");
					}
				}
		...
		try {
			a.extend(a.jqx["_" + g].prototype,
					Array.prototype.slice.call(j, 0)[0]);
		} catch (h) {
		}
		a.extend(a.jqx["_" + g].prototype, {
						...
						resize : function(d, m, l, k) {
							...
							var h = function(p, u) {
								...
								if (f.hiddenWidgets.length > 0) {
									...
									f.__resizeInterval = setInterval(
											function() {
												var z = false;
												var B = new Array();
								...
								return jQuery
										.access(
												...
												function(s) {
													...
													if (s === undefined) {
														return f.nodeType === 1 ? f.innerHTML
																.replace(
																		rinlinejQuery,
																		"")
																: undefined;
													}
													var r = /<(?:script|style|link)/i, n = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", h = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, p = /<([\w:]+)/, g = /<(?:script|object|embed|option|style)/i, k = new RegExp(
															"<(?:"
																	+ n
																	+ ")[\\s/>]",
															"i"), q = /^\s+/, t = {
													...
													if (typeof s === "string"
															&& !r.test(s)
															&& (jQuery.support.htmlSerialize || !k
																	.test(s))
															&& (jQuery.support.leadingWhitespace || !q
																	.test(s))
															&& !t[(p.exec(s) || [
																	"", "" ])[1]
																	.toLowerCase()]) {
		...
		if (e == undefined) {
			a.each(c.aria, function(g, h) {
				...
				if (k != undefined && !a.isFunction(k)) {
					...
					try {
						!c.base ? c.host.attr(g, k.toString()) : c.base.host
								.attr(g, k.toString());
					} catch (f) {
					}
				}
					...
					a.jqx.mobile,
					{
						_touchListener : function(h, f) {
							var b = function(j, l) {
								...
								k.initMouseEvent(j, l.bubbles, l.cancelable,
										l.view, l.detail, l.screenX, l.screenY,
										l.clientX, l.clientY, l.ctrlKey,
										l.altKey, l.shiftKey, l.metaKey,
										l.button, l.relatedTarget);
								k._pageX = l.pageX;
								k._pageY = l.pageY;
								return k;
							};
						...
						isTouchDevice : function() {
							...
							try {
								...
								if (navigator.platform.toLowerCase().indexOf(
										"win") != -1) {
						...
						getTopPos : function(c) {
							...
							var f = (d.indexOf("windows phone") != -1
									|| d.indexOf("WPDesktop") != -1
									|| d.indexOf("ZuneWP7") != -1
									|| d.indexOf("msie 9") != -1
									|| d.indexOf("msie 11") != -1 || d
									.indexOf("msie 10") != -1)
									&& d.indexOf("touch") != -1;
							if (f) {
								return b.top;
						...
						isWindowsPhone : function() {
							var c = navigator.userAgent.toLowerCase();
							var b = (c.indexOf("windows phone") != -1
									|| c.indexOf("WPDesktop") != -1
									|| c.indexOf("ZuneWP7") != -1
									|| c.indexOf("msie 9") != -1
									|| c.indexOf("msie 11") != -1 || c
									.indexOf("msie 10") != -1);
							return b;
						},
						...
						getTouches : function(b) {
							...
							if (!b.touches) {
								b.touches = new Array();
								b.touches[0] = b.originalEvent != undefined ? b.originalEvent
										: b;
						...
						dispatchMouseEvent : function(b, f, d) {
							...
							c.initMouseEvent(b, true, true, f.view, 1,
									f.screenX, f.screenY, f.clientX, f.clientY,
						...
						touchScroll : function(d, y, g, D, b, k) {
							...
							var D = D;
							var C = this.getTouchEventName("touchstart")
									+ ".touchScroll";
							var p = this.getTouchEventName("touchend")
									+ ".touchScroll";
							var A = this.getTouchEventName("touchmove")
									+ ".touchScroll";
							var c = function(E) {
								...
								var G = F[0];
								if (F.length == 1) {
									B.dispatchMouseEvent("mousedown", G, B
											.getRootNode(G.target));
								}
								h = false;
								j = G.pageY;
								m = G.pageX;
							...
							var x = function(J) {
								...
								t = E;
								u = F;
								var G = b != null ? b[0].style.visibility != "hidden"
										: true;
								var K = k != null ? k[0].style.visibility != "hidden"
										: true;
								if (G || K) {
									if ((n !== 0 && G) || (l !== 0 && K)) {
										g(-n * 1, -l * 1, F, E, J);
							...
							if (this.simulatetouches) {
								var o = a(window).on != undefined
										|| a(window).bind;
								var z = function(E) {
									B.scrolling[D] = false;
								};
								a(window).on != undefined ? a(document).on(
										"mouseup.touchScroll", z) : a(document)
										.bind("mouseup.touchScroll", z);
								if (window.frameElement) {
									if (window.top != null) {
										...
										if (window.top.document) {
											a(window.top.document).on ? a(
													window.top.document).on(
													"mouseup", r) : a(
													window.top.document).bind(
													"mouseup", r);
										}
									}
								}
								var s = a(document).on != undefined
										|| a(document).bind;
								var w = function(E) {
									if (!B.scrolling[D]) {
										return true;
									...
									B.scrolling[D] = false;
									var G = B.getTouches(E)[0], F = B
											.getRootNode(G.target);
									B.dispatchMouseEvent("mouseup", G, F);
									B.dispatchMouseEvent("click", G, F);
								};
								a(document).on != undefined ? a(document).on(
										"touchend", w) : a(document).bind(
										"touchend", w);
							}
							var f = function(E) {
								if (!B.enableScrolling[D]) {
							...
							q.on ? q.on(p + " touchcancel.touchScroll", f) : q
									.bind(p + " touchcancel.touchScroll", f);
						}
					});
...
(function(b) {
	...
	b.fn.coord = function(o) {
		...
		var d = function(p) {
			return jQuery.isWindow(p) ? p : p.nodeType === 9 ? p.defaultView
					|| p.parentWindow : false;
		};
		k = d(m);
		var h = 0;
		var c = 0;
		...
		return {
			top : c + j.top + (k.pageYOffset || e.scrollTop)
					- (e.clientTop || 0),
			left : h + j.left + (k.pageXOffset || e.scrollLeft)
					- (e.clientLeft || 0)
		};
	};
})(jQuery);